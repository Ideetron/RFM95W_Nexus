...
/*
*****************************************************************************************
* Description : Function to calculate the MIC of hte complete radio package
*
...
void Calculate_MIC(unsigned char *Data, unsigned char *Final_MIC, unsigned char Data_Length, unsigned int Frame_Counter)
{
  ...
  //Add one for the last incomplet block
	if(Incomplete_Block_Size != 0)
	{
		Number_of_Blocks++;
	}

  //Generet the keys used in the MIC calculation
